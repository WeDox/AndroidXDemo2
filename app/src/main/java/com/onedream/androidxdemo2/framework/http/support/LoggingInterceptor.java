...
//                        MovieApi.BodyOut out = GsonUtils.GsonToBean(data,MovieApi.BodyOut.class);
//                        try {
//                            JSONObject object = new JSONObject(out.getBizContent());
...
//                        }
//                    }
//                    UserLoginData tokenData = GsonUtils.GsonToBean(data,UserLoginData.class);
//                    if(!tokenData.getToken().equals("null") ||!tokenData.getToken().equals("")){
//                        logger.log("token:" + tokenData.getToken());
//                        BookApi.Token = tokenData.getToken();
//                    }
